...
function PapersList() {
    ...
    useEffect(() => {
        // Aggiorna i paper visualizzati quando cambia il conteggio visibile
    ...
    return (
        ...
        {displayedPapers.map((paper) => (
          <Link key={paper.id} href={`/papers/${paper.slug}`} className='m-5 p-4'>
